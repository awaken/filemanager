...
require (
	...
	github.com/hashicorp/golang-lru/arc/v2 v2.0.3 // indirect
...
replace github.com/GoAdminGroup/go-admin => github.com/awaken/go-admin v0.0.0-20230607104959-25f5928dbbe4
